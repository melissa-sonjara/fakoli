 ...
 *
 */
class Dial extends Chart
{
	constructor(id, value, label, options)
	{
		super(id);
		this.value = value;
		this.label = label;
	...
	updateTarget(showTarget, target, targetLabel)
	{
	...
	updateColorRange(min, max, redraw)
	{
