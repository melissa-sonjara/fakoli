...
class StraightRadarSeriesRenderer
{
...
class SmoothedRadarSeriesRenderer extends StraightRadarSeriesRenderer
{
	constructor(chart, series, index)
	{
		super(chart, series, index);
	}
...
class RadarChart extends Chart
{
	...
	calculatePoint(angle, magnitude)
	{
