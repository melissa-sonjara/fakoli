var HistogramSeries = new Class(
{
	...
	showToolTip: function(element, evt, idx)
	{
		if (idx > this.options.tooltips.length) return;
		
		showTextToolTip(element, evt, this.chart.id, this.options.tooltips[idx]);
	},
...
var LineSeriesRenderer = new Class(
{
	...
	draw: function()
	{
		...
		this.coords.each(function(c, i) {
			...
			dot.mouseover(function(e) {dot.animate({'r': this.series.options.symbolSize * 2}, 250, "backout"); this.series.showToolTip($(dot), e, i);}.bind(this));
